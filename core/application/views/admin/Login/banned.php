...
<html lang="en">
  ...
  <body>
		<div class="container well well-small text-center dir-rtl">
       		<h4>آی پی شما بسته شد .</h4><h5>شما اجازه وارد شدن به بخش مدیریت را ندارید.</h5>
        </div>
  </body>
</html>
